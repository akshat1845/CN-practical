...
<p align="center">
  <img src="./practical%2015/Pasted%2024-09-2026%20at%2014.43.23.png" alt="Practical 15 Topology" width="850"/>
  <br/><em>Figure 15.1: Practical 15 Complete Network Topology</em>
</p>
...
<p align="center">
  <img src="./practical%2015/R0%20config.png" alt="R0 Interface Brief" width="700"/>
  <br/><em>Figure 15.2: R0 Interface Status (show ip interface brief)</em>
</p>
...
<p align="center">
  <img src="./practical%2015/R1%20config.png" alt="R1 Interface Brief" width="700"/>
  <br/><em>Figure 15.3: R1 Interface Status (show ip interface brief)</em>
</p>
...
<p align="center">
  <img src="./practical%2015/R2%20config.png" alt="R2 Interface Brief" width="700"/>
  <br/><em>Figure 15.4: R2 Interface Status (show ip interface brief)</em>
</p>
...
<p align="center">
  <img src="./practical%2015/R0%20route.png" alt="R0 Routing Table" width="750"/>
  <br/><em>Figure 15.5: R0 Routing Table verifying VLSM routes</em>
</p>
...
<p align="center">
  <img src="./practical%2015/ping.png" alt="Ping Test Practical 15" width="700"/>
  <br/><em>Figure 15.6: Successful Ping Verification across VLSM subnets</em>
</p>
...
- Point-to-point Serial eBGP connection (`se0/0` on R0 ↔ `se1/0` on R1)
- LAN networks behind switches **S0** and **S1** with 4 PCs

<p align="center">
  <img src="./practical%2016/Pasted%2024-09-2026%20at%2015.45.49.png" alt="Practical 16 Topology" width="850"/>
  <br/><em>Figure 16.1: BGP Inter-AS Topology (AS 100 ↔ AS 200)</em>
</p>
...
| :--- | :--- | :--- | :--- |
| **AS 100 LAN** | `172.16.1.0/24` | `255.255.255.0` | R0 (`fa1/0` / `fa2/0`), PC0, PC1 |
| **AS 200 LAN** | `172.16.2.0/24` | `255.255.255.0` | R1 (`fa1/0` / `fa2/0`), PC2, PC3 |
| **eBGP WAN Link** | `203.0.113.0/30` | `255.255.255.252` | R0 (`se0/0`: .1) ↔ R1 (`se1/0`: .2) |
...
<p align="center">
  <img src="./practical%2016/R0%20config.png" alt="R0 BGP Interface Brief" width="700"/>
  <br/><em>Figure 16.2: R0 Interface Brief</em>
</p>
...
<p align="center">
  <img src="./practical%2016/R1%20config.png" alt="R1 BGP Interface Brief" width="700"/>
  <br/><em>Figure 16.3: R1 Interface Brief</em>
</p>
...
<p align="center">
  <img src="./practical%2016/R0%20bgp%20summary.png" alt="R0 BGP Summary" width="750"/>
  <br/><em>Figure 16.4: R0 BGP Neighbor Summary</em>
</p>

- **R1 Neighbor Summary (AS 200)**: Neighbor `203.0.113.1` is established in remote AS 100.
<p align="center">
  <img src="./practical%2016/R1%20bgp%20summary.png" alt="R1 BGP Summary" width="750"/>
  <br/><em>Figure 16.5: R1 BGP Neighbor Summary</em>
</p>
...
<p align="center">
  <img src="./practical%2016/R0%20bgp%20table.png" alt="R0 BGP Table" width="750"/>
  <br/><em>Figure 16.6: R0 BGP Routing Table</em>
</p>
...
<p align="center">
  <img src="./practical%2016/Pasted%2024-09-2026%20at%2015.50.27.png" alt="BGP Ping Test" width="700"/>
  <br/><em>Figure 16.7: Successful Ping Verification across AS 100 and AS 200</em>
</p>
